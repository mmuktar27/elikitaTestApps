...
const VolunteerModal = () => {
  ...
  >
    ...
    />
      ...
      <DialogContent className="mx-auto max-w-xs sm:max-w-md">
  <DialogHeader>
  ...
  <div className="space-y-6 p-6">
    <div className="flex flex-col items-center gap-6">
      <a
        ...
        className="w-auto rounded-lg bg-[#2B5845] px-6 py-3 text-center text-white transition-transform hover:scale-105"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-auto rounded-lg bg-[#3A4F39] px-6 py-3 text-center text-white transition-transform hover:scale-105"
      >
