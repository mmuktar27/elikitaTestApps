...
function LayoutPage({ children }) {
      ...
      >
        ...
        <nav className="space-y-2">
          ...
          <NavItem
            icon={Users}
            label="Patients"
            active={routes === "/remotedoctor/patients"}
  ...
  label="Availability Register" 
  active={routes === "/remotedoctor/availabilityRegister"} 
  url={"/remotedoctor/availabilityRegister"} />
